// LinkNest — versi siap deploy di GitHub Pages
// Petunjuk deploy:
// 1. Buat repository baru di GitHub.
// 2. Jalankan `npm create vite@latest linknest --template react`.
// 3. Ganti isi `src/App.jsx` dengan kode ini.
// 4. Jalankan `npm install && npm run dev` untuk cek lokal.
// 5. Tambahkan Tailwind CSS (instruksi di https://tailwindcss.com/docs/guides/vite).
// 6. Build: `npm run build`.
// 7. Deploy ke GitHub Pages:
//    - Tambah di `vite.config.js`: `base: '/nama-repo/'`
//    - Jalankan `npm run build`.
//    - Commit & push folder `dist` ke branch `gh-pages` atau pakai GitHub Actions otomatis.
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow p-6 flex flex-col items-center">
        ...
        <div className="mt-6 text-center text-xs text-gray-500">LinkNest by kamu — deploy ke GitHub Pages ✨</div>
      </div>
